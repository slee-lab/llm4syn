...
with open(f'./save/lhs2rhs_m0_{num_sample}_{tag}.pkl', 'wb') as f:
    pkl.dump(chem_dict, f)

from utils.periodic_trends import plotter
p = plotter(filename, output_filename=f'./save/lhs2rhs_m0_{num_sample}_{tag}.html', under_value=0, over_value=1)
