...
out_conf_dict = {'lhs2rhs': {'type': 'mul', 'value': 10}, 
                 'rhs2lhs': {'type': 'mul', 'value': 10}, 
                 'tgt2ceq': {'type': 'mul', 'value': 10}, 
                 'lhsope2rhs': {'type': 'mul', 'value': 10}, 
                 'rhsope2lhs': {'type': 'mul', 'value': 10}, 
                 'tgtope2ceq': {'type': 'mul', 'value': 10}}
