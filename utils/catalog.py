...
out_conf_dict = {'lhs2rhs': {'type': 'mul', 'value': 10},   # 2.1
                 'rhs2lhs': {'type': 'mul', 'value': 10},   # 2.1
                 'tgt2ceq': {'type': 'mul', 'value': 10},   # 4.0
                 'lhsope2rhs': {'type': 'mul', 'value': 10},    # 2.1
                 'rhsope2lhs': {'type': 'mul', 'value': 10},    # 2.1
                 'tgtope2ceq': {'type': 'mul', 'value': 10}}    # 4.0
