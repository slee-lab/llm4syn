...
dataset = Dataset_Ceq(data1, index=None, te_ratio=0.1, separator=separator, cut=cut).dataset 
hf_model = "bert-base-uncased" #"distilbert-base-uncased"
model_name = hf_usn + '/eq_bert_v1.1'# '/syn_distilgpt2_v2'
